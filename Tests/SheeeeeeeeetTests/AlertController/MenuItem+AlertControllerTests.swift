//
//  MenuItem+AlertControllerTests.swift
//  Sheeeeeeeeet
//
...
class MenuItem_AlertControllerTests: QuickSpec {
    ...
    override func spec() {
        ...
        describe("can be used in context menu") {
            ...
            func result(for item: MenuItem) -> Bool {
                item.canBeUsedInAlertController
            }
            ...
            it("is true for items that can be mapped to `UIAction` and still serve their purpose") {
                ...
                expect(result(for: DestructiveButton(title: ""))).to(beTrue())
        ...
        describe("should be ignored by context menu") {
            ...
            func result(for item: MenuItem) -> Bool {
                item.shouldBeIgnoredByAlertController
            }
        ...
        describe("creating context menu action") {
            ...
            func result(for item: MenuItem) -> Bool {
                switch (item.toAlertAction { _ in }) {
